...
const BC_AVATAR_COLORS = ['#E5572F', '#3F6E55', '#B7873A', '#7B5E8C', '#4A6B7C', '#A4452C', '#5B6E3F', '#8C5E3E']
...
const BC_USERS = [
  {
    ...
    auth0_id: 'a|me',
    display_name: 'You',
    email: 'you@billchill.app',
    avatar_url: null,
  },
  {
    id: 'u_sam',
    auth0_id: 'a|sam',
    display_name: 'Sam Bui',
    email: null,
    avatar_url: null,
  },
  {
...
const BC_EXPENSES = [
  // Rome trip
  {
    ...
    amount: 420.0,
    currency: 'EUR',
    description: 'Trastevere apartment, 3 nights',
    category: 'lodging',
    date: '2026-04-26',
    created_at: '2026-04-26T18:02:00Z',
    created_by: 'u_me',
  },
  {
    id: 'e_2',
  ...
  },
  {
    id: 'e_3',
    group_id: 'g_rome',
    paid_by: 'm_rome_jules',
    amount: 32.0,
    currency: 'EUR',
    description: 'Taxi from Termini',
    category: 'transport',
    date: '2026-04-26',
  ...
  },
  {
    ...
    amount: 18.0,
    currency: 'EUR',
    description: 'Gelato run',
    category: 'food',
    date: '2026-04-28',
    created_at: '2026-04-28T21:08:00Z',
    created_by: 'u_sam',
  },
  ...
  // Book club
  {
    ...
    amount: 76.2,
    currency: 'USD',
    description: '5 copies of Piranesi',
    category: 'fun',
    date: '2026-05-12',
  ...
  },
  {
    ...
    amount: 42.0,
    currency: 'USD',
    description: 'Wine for May meeting',
    category: 'drinks',
    date: '2026-05-18',
...
function evenSplit(expenseId, amount, memberIds) {
  ...
  return memberIds.map((mid, i) => ({
    ...
    member_id: mid,
    share_amount: Math.round(each * 100) / 100,
  }))
}

const BC_SPLITS = [
  ...evenSplit('e_1', 420.0, ['m_rome_me', 'm_rome_sam', 'm_rome_jules', 'm_rome_nico']),
  // e_2 dinner uneven
  {
    id: 's_e2_0',
    expense_id: 'e_2',
  ...
  },
  {
    id: 's_e2_1',
    expense_id: 'e_2',
    member_id: 'm_rome_sam',
    share_amount: 26.0,
  },
  {
    id: 's_e2_2',
    expense_id: 'e_2',
    member_id: 'm_rome_jules',
    share_amount: 26.0,
  },
  {
    id: 's_e2_3',
    expense_id: 'e_2',
    member_id: 'm_rome_nico',
    share_amount: 12.5,
  },

  ...evenSplit('e_3', 32.0, ['m_rome_me', 'm_rome_sam', 'm_rome_jules', 'm_rome_nico']),
  ...evenSplit('e_4', 64.2, ['m_rome_me', 'm_rome_sam', 'm_rome_jules', 'm_rome_nico']),
  ...evenSplit('e_5', 23.4, ['m_rome_me', 'm_rome_sam', 'm_rome_jules', 'm_rome_nico']),
  ...evenSplit('e_6', 18.0, ['m_rome_me', 'm_rome_sam', 'm_rome_jules', 'm_rome_nico']),

  ...evenSplit('e_10', 1840.0, ['m_apt_me', 'm_apt_reb', 'm_apt_mo']),
  ...evenSplit('e_11', 84.3, ['m_apt_me', 'm_apt_reb', 'm_apt_mo']),
  ...evenSplit('e_12', 132.5, ['m_apt_me', 'm_apt_reb', 'm_apt_mo']),
  ...evenSplit('e_13', 39.99, ['m_apt_me', 'm_apt_reb', 'm_apt_mo']),

  ...evenSplit('e_20', 76.2, ['m_book_me', 'm_book_reb', 'm_book_jules', 'm_book_sam', 'm_book_kira']),
  ...evenSplit('e_21', 42.0, ['m_book_me', 'm_book_reb', 'm_book_jules', 'm_book_sam', 'm_book_kira']),
]
...
const BC_SETTLEMENTS = [
  ...
  },
  {
    id: 'st_2',
    group_id: 'g_apt',
    from_member: 'm_apt_mo',
    to_member: 'm_apt_me',
    amount: 200.0,
    currency: 'USD',
    settled_at: '2026-05-12T16:30:00Z',
    created_by: 'u_mo',
  },
]
...
const BC_NOTIFICATIONS = [
  {
    ...
    group_id: 'g_rome',
    type: 'expense_added',
    params: { actor: 'Sam', what: 'Dinner — Da Enzo', amount: '€88.50' },
    is_read: false,
    created_at: '2026-04-27T22:10:00Z',
  },
  {
    ...
    params: { from: 'Mo', to: 'You', amount: '$200.00' },
    is_read: false,
    created_at: '2026-05-12T16:30:00Z',
  },
  {
    id: 'n_3',
    user_id: 'u_me',
    group_id: 'g_book',
    type: 'expense_added',
    params: { actor: 'Reb', what: '5 copies of Piranesi', amount: '$76.20' },
    is_read: true,
    created_at: '2026-05-12T19:00:00Z',
  },
  {
    ...
    group_id: 'g_rome',
    type: 'reminder',
    params: { name: 'Nicolò', amount: '€40.60' },
    is_read: true,
  ...
  },
  {
    ...
    group_id: 'g_rome',
    type: 'member_joined',
    params: { name: 'Nicolò', group: 'Rome trip' },
    is_read: true,
