  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '28px 26px 0' }}>
        <div style={{
          fontFamily: "'Newsreader', serif", fontSize: 40, lineHeight: 1.02,
          color: theme.ink, letterSpacing: '-0.025em',
        }}>
          {tagline.map((line, i) => (
            <div key={i} style={{
        ...
        <div style={{
          marginTop: 14, fontFamily: 'Be Vietnam Pro', fontSize: 15, color: theme.muted,
          letterSpacing: '-0.005em', lineHeight: 1.45, maxWidth: 320,
        }}>
          {T('landing.subhead')}
        </div>
      </div>
      ...
      <div style={{ flex: 1 }} />
      <div style={{ padding: '12px 26px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
        <FeatureRow theme={theme} accent={accent} glyph="L" tint={theme.ink}
          title={T('landing.feature_ledger_t')} body={T('landing.feature_ledger_b')} />
        <FeatureRow theme={theme} accent={accent} glyph="S" tint="#3F6E55"
          title={T('landing.feature_smart_t')} body={T('landing.feature_smart_b')} />
        <FeatureRow theme={theme} accent={accent} glyph="¤" tint="#B7873A"
          title={T('landing.feature_multi_t')} body={T('landing.feature_multi_b')} />
      </div>

      {/* CTAs */}
      <div style={{ padding: '24px 22px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
        <button onClick={onLogin} className="bc-tap" style={{
        ...
        <button onClick={onDemo} className="bc-tap" style={{
          background: 'transparent', color: theme.ink, border: 'none', cursor: 'pointer',
          padding: '10px 22px',
          fontFamily: 'Be Vietnam Pro', fontWeight: 500, fontSize: 13, letterSpacing: '0.02em',
          textTransform: 'uppercase',
        }}>{T('landing.cta_demo')}</button>
        <div style={{
          marginTop: 4, fontFamily: 'Be Vietnam Pro', fontSize: 11, color: theme.muted,
          textAlign: 'center', lineHeight: 1.4, letterSpacing: '-0.005em',
        }}>{T('landing.legal')}</div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
      ...
      <div style={{ minWidth: 0, flex: 1 }}>
        ...
        <div style={{
          fontFamily: 'Be Vietnam Pro', fontSize: 12, color: theme.muted, marginTop: 2,
        }}>{body}</div>
      </div>
    </div>
  );
...
function LedgerHero({ theme, accent }) {
  return (
    <div style={{ position: 'relative', height: 168 }}>
      {/* Receipt 3 (back) */}
      <div style={{
        position: 'absolute', left: 20, top: 16, width: 220, height: 132,
        background: theme.surface, border: `1px solid ${theme.softhair}`,
        ...
        <div style={{ flex: 1 }} />
        <div style={{
          fontFamily: "'Newsreader', serif", fontSize: 22, color: '#3F6E55',
          letterSpacing: '-0.01em', alignSelf: 'flex-end',
        }}>$84.30</div>
      </div>
      {/* Receipt 2 (mid) */}
      <div style={{
        position: 'absolute', right: 12, top: 6, width: 230, height: 138,
        background: theme.surface, border: `1px solid ${theme.softhair}`,
      ...
      <div style={{
        position: 'absolute', left: '50%', bottom: 0, width: 200, height: 110,
        transform: 'translateX(-50%) rotate(-1.5deg)',
        background: accent, color: '#fff',
        borderRadius: 16, padding: 14, boxSizing: 'border-box',
        boxShadow: `0 14px 30px ${accent}40`,
        display: 'flex', flexDirection: 'column',
      }}>
        <div style={{
          fontFamily: 'Be Vietnam Pro', fontSize: 10, color: 'rgba(255,255,255,0.7)',
          textTransform: 'uppercase', letterSpacing: '0.12em',
        }}>Settle up</div>
        <div style={{
          fontFamily: "'Newsreader', serif", fontSize: 36, marginTop: 4, letterSpacing: '-0.02em',
        }}>$1,270.22</div>
        <div style={{ flex: 1 }} />
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <div style={{ width: 22, height: 22, borderRadius: 999, background: 'rgba(255,255,255,0.25)',
            display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <BCIcon name="check" size={12} color="#fff" stroke={2.6} />
          </div>
          <div style={{
            fontFamily: 'Be Vietnam Pro', fontSize: 12, color: 'rgba(255,255,255,0.85)', letterSpacing: '-0.005em',
          }}>4 people · 1 transfer</div>
        </div>
      </div>
    </div>
  );
...
function AuthSheet({ theme, accent, T, onClose, onSuccess }) {
  ...
  return (
    <div style={{
      ...
      {/* Backdrop */}
      <div onClick={stage === 'idle' ? onClose : null} style={{
      ...
      {/* Sheet */}
      <div style={{
        position: 'relative', width: '100%', background: theme.bg, color: theme.ink,
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '10px 0 6px' }}>
          <div style={{ width: 38, height: 4, borderRadius: 999, background: theme.hair }} />
        </div>
          ...
          <React.Fragment>
            <div style={{ padding: '4px 24px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ minWidth: 0 }}>
                <div style={{
                  fontFamily: "'Newsreader', serif", fontSize: 30, color: theme.ink, letterSpacing: '-0.02em', whiteSpace: 'nowrap',
                }}>{T('auth.title')}</div>
                <div style={{
                  fontFamily: 'Be Vietnam Pro', fontSize: 11, color: theme.muted,
                  letterSpacing: '0.12em', textTransform: 'uppercase', marginTop: 6, whiteSpace: 'nowrap',
                }}>{T('auth.subhead')}</div>
              </div>
              <button onClick={onClose} className="bc-tap" style={{
                width: 36, height: 36, borderRadius: 999, border: 'none', background: theme.chip,
                cursor: 'pointer', color: theme.ink, display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
              ...
              <div style={{
                ...
                <input
                  ...
                  style={{
                    ...
                    fontFamily: 'Be Vietnam Pro', fontSize: 15, color: theme.ink, letterSpacing: '-0.005em',
                  }} />
              </div>

              <button onClick={() => start('email')} className="bc-tap" style={{
                marginTop: 12, width: '100%', background: accent, color: '#fff',
                border: 'none', cursor: 'pointer', padding: '14px 22px', borderRadius: 999,
                fontFamily: 'Be Vietnam Pro', fontWeight: 500, fontSize: 15, letterSpacing: '-0.005em',
              }}>{T('auth.continue_email')}</button>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '20px 24px 14px' }}>
              ...
              <div style={{ fontFamily: 'Be Vietnam Pro', fontSize: 11, color: theme.muted, letterSpacing: '0.08em', textTransform: 'uppercase' }}>{T('auth.divider')}</div>
              <div style={{ flex: 1, height: 1, background: theme.softhair }} />
            </div>
            ...
            <div style={{ padding: '0 22px', display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <SsoButton theme={theme} icon={<AppleMark color={theme.ink} />} label={T('auth.continue_apple')} onClick={() => start('apple')} />
            </div>

            {/* Auth0 footer */}
            <div style={{
              marginTop: 22, padding: '12px 24px 4px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
              fontFamily: 'Be Vietnam Pro', fontSize: 11, color: theme.muted, letterSpacing: '0.06em', whiteSpace: 'nowrap',
            }}>
...
function SsoButton({ theme, icon, label, onClick }) {
  return (
    <button onClick={onClick} className="bc-tap" style={{
      ...
      background: theme.surface, color: theme.ink, border: `1px solid ${theme.softhair}`,
...
function SigningInState({ theme, accent, T, provider, email }) {
  return (
    <div style={{
      padding: '20px 24px 28px', display: 'flex', flexDirection: 'column',
      alignItems: 'center', gap: 22,
    }}>
      <BcSpinner color={accent} />
      <div style={{ textAlign: 'center' }}>
        <div style={{
          fontFamily: "'Newsreader', serif", fontSize: 26, color: theme.ink,
          letterSpacing: '-0.02em',
        }}>{T('auth.signing_in')}</div>
        <div style={{ marginTop: 6, fontFamily: 'Be Vietnam Pro', fontSize: 13, color: theme.muted }}>
...
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18">
      ...
      <path d="M9 18c2.43 0 4.47-.8 5.96-2.18l-2.92-2.26c-.81.54-1.84.86-3.04.86-2.34 0-4.32-1.58-5.02-3.7H.92v2.32A9 9 0 009 18z" fill="#34A853"/>
      ...
      <path d="M9 3.58c1.32 0 2.5.45 3.44 1.34l2.58-2.58A9 9 0 009 0 9 9 0 00.92 4.96L3.98 7.28C4.68 5.16 6.66 3.58 9 3.58z" fill="#EA4335"/>
    </svg>
  );
}
...
function Auth0Mark({ color = '#000' }) {
  ...
  return (
    <span style={{
      fontFamily: 'Be Vietnam Pro', fontWeight: 700, fontSize: 11, color, letterSpacing: '0.02em',
    }}>auth0</span>
  );
}

Object.assign(window, {
  LandingScreen, AuthSheet, BcSpinner,
});
